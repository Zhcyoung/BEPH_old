...
from datasets_CLAM.dataset_generic import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset, save_splits
import h5py
...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/normal_tumor.csv',
    ...
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/CLAM/BRCA/FEATURES_DIRECTORY/Step_3.csv',
                            data_dir= os.path.join(args.data_root_dir, './'),
                            shuffle = False, 
                            print_info = True,
